...
Route::get('/razorpay-view', 'RazorpayPaymentController@show')->name('razorpayview');
Route::post('/profile/mobileAdd','UserController@mobileAdd')->name('profile.mobileAdd');
...
Route::get('head-hunting','HeadHuntingController@index')->name('head.hunting');
Route::post('head-hunting','HeadHuntingController@store')->name('head.hunting.store');
...
Route::get('/recruiter-terms', function () {
  return view('recruiter-terms');
...
Route::get('/sitemap-generate', 'IndexController@generateSitemap')->name('sitemap-generate');
