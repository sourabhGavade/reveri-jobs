...
Route::get('/head-hunting', array_merge(['uses' => 'HeadHuntingController@view'], $all_users))->name('admin.head.hunting');
// Route::get('/head-hunting', array_merge(['uses' => 'HeadHuntingController@data'], $all_users))->name('admin.head.hunting.data');
