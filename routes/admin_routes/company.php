...
Route::delete('delete-companies-bulk', array_merge(['uses' => 'Admin\CompanyController@deleteCompaniesBulk'], $all_users))->name('delete.companies.bulk');
...
Route::put('make-approved-company', array_merge(['uses' => 'Admin\CompanyController@makeApprovedCompany'], $all_users))->name('make.approved.company');
Route::put('make-not-approved-company', array_merge(['uses' => 'Admin\CompanyController@makeNotApprovedCompany'], $all_users))->name('make.not.approved.company');
/* * ****** End Company ********** */
