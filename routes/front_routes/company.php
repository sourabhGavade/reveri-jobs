...
Route::get('list-suggested-candidates/{job_id}', 'Company\CompanyController@listsuggestedcandidates')->name('list.suggested.candidates');
Route::post('save-suggested-candidates', 'Company\CompanyController@savesuggestedcandidates')->name('save.suggested.candidates');
...
Route::get('company-transaction', 'Company\CompanyController@companyTransaction')->name('company.transaction');
