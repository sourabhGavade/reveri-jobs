                    ...
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    <p>Following email has been recieved from HeadHunting form :</p>
                                    ...
                                    <p><strong>Job Profile</strong> : {{ $data->job_profile_name }} </p>
                                    <p><strong>Industry</strong> : {{ $data->industry_name }} </p>
                                    <p><strong>Functional Area</strong> : {{ $data->functional_area_name }} </p>
                                    <p><strong>Target Industry</strong> : {{ $data->target_industry }} </p>
                                    <p><strong>Target Designation</strong> : {{ $data->target_designation }} </p>
                                    <p><strong>Target Salary</strong> : {{ $data->target_salary }} </p>
