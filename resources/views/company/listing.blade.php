@extends('layouts.app')
@push('metadetails')
<title>Reveri Jobs - Jobs in Food Companies | Apply Now</title>
<meta name="title" content="Reveri Jobs - Jobs in Food Companies | Apply Now">
<meta name="description" content="Uncover key jobs in the food companies with Reveri Jobs">
@endpush
@section('content') 
<!-- Header start --> 
