...
@push('metadetails')
<title>Reveri Jobs - Contact us to Register</title>
<meta name="title" content="Reveri Jobs - Contact us to Register">
<meta name="description" content="Whether you are an Employer or a candidate in the Food Sector, Contact us to Register with us.">
@endpush
        ...
        <div class="contact-wrap">
            <div class="title">
                    ...
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-envelope"></i></span>
                            <div class="information"> <strong>{{__('Email Address')}}:</strong>
                                <p><a href="mailto:{{ $siteSetting->mail_to_address }}"  class="information_connection">{{ $siteSetting->mail_to_address }}</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- Contact Info -->
                    <div class="col-lg-4 column">
                        <div class="contact"> <span><i class="fa fa-phone"></i></span>
                            <div class="information"> <strong>{{__('Phone')}}:</strong>
                                <p><a href="tel:{{ $siteSetting->site_phone_primary }}" class="information_connection">{{ $siteSetting->site_phone_primary }}</a></p>
                                <p><a href="tel:{{ $siteSetting->site_phone_secondary }}"  class="information_connection">{{ $siteSetting->site_phone_secondary }}</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- Contact Info -->
                ...
                <div class="col-lg-4 column">
                    <!-- Google Map -->
                    <div class="googlemap">
                         <iframe src="{{ $siteSetting->site_google_map }}" allowfullscreen></iframe>
                    </div>
                </div>
                <!-- Contact form -->
                <div class="col-lg-8 column">
                    <div class="contact-form">
                        <h4 class="text-left">Fill this form and we will contact you</h4>
                        <div id="message"></div>
                        <form class="ajaxformclass" method="post" action="{{ route('contact.us.post')}}">
                            {{ csrf_field() }}
                            <div class="row">
