                ...
                <div class="jobmainreq">
                    <div class="jobdetail">
                       <h3><i class="fa fa-align-left" aria-hidden="true"></i> {{__('Job Detail')}}</h3>
                            ...
                            <li class="row">
                                <div class="col-md-4 col-xs-5">{{__('Functional Area')}}:</div>
                                <div class="col-md-8 col-xs-7"><span>{{$job->getFunctionalArea('functional_area')}}</span></div>
                            </li>
                            <li class="row">
                                <div class="col-md-4 col-xs-5">{{__('Industry')}}:</div>
                                <div class="col-md-8 col-xs-7"><span><?php $industryId = $job->getCompany('industry_id'); $getIndustryDetail = DB::table('industries')->where('industry_id',$industryId)->get(); echo $getIndustryDetail[0]->industry; ?></span></div>
                            </li>
                            <li class="row">
