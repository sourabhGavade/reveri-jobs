                        ...
                        <li>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <div class="jobinfo">
                                                ...
                                                <h5 class="cityName"><span>{{$job->getCity('city')}}</span></h5>
                                            </div>
                                ...
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <div class="listbtn"><a href="{{route('job.detail', [$job->slug])}}">{{__('Details')}}</a></div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="companyName"><a href="javascript:void(0)" title="{{$company->getIndustry('industry')}}"><b style="color:black;font-weight:600;">Industry:- </b>{{$company->getIndustry('industry')}}</a></div>
                                    <div class="companyName"><a href="javascript:void(0)" title="{{$job->getFunctionalArea('functional_area')}}"><b style="color:black;font-weight:600;">Functional Area:- </b>{{$job->getFunctionalArea('functional_area')}}</a></div>
                                    <div class="location">
