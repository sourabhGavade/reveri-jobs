...
<h3 class="seekertxt">{{__('We are food consultants who will help you find the right Job')}}. <span>{{__('Search Jobseekers Today')}}.</span></h3>
...
@else
<h3>{{__('We are food consultants who will help you find the right Job')}}</h3>
    ...
    <div class="searchbar">
		...
		<div class="row">
			<div class="col-lg-9 col-md-8">
				...
				<input type="text"  name="search" id="jbsearch" value="{{Request::get('search', '')}}" class="form-control" placeholder="{{__('Enter job position')}}" autocomplete="off" /></div>
        ...
        {{-- {!! Form::select('category_id', $functionalAreas, null, ['class' => 'form-control']) !!} --}}
<div class="col-lg-3">
			<label for="">{{__('Select Job Position')}}</label>
            {!! Form::select('career_level_id[]', ['' => __('Select Job Position')]+$jobpositions, Request::get('career_level_id', null), array('class'=>'form-control', 'id'=>'career_level_id')) !!}
        </div> 
         <div class="col-lg-3">
