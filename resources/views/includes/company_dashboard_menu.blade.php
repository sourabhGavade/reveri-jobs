<div class="col-md-3 col-sm-4">
    ...
    <ul class="usernavdash">
        ...
        <li><a href="{{route('company.transaction')}}"><i class="fa fa-users" aria-hidden="true"></i> {{__('Transactions')}}</a></li>
        <li><a href="{{route('head.hunting')}}"><i class="fa fa-users" aria-hidden="true"></i> {{__('Head Hunting')}}</a></li>
