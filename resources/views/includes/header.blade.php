                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
							...
							<li class="nav-item {{ Request::url()}}"><a href="{{url('/about-us')}}" class="nav-link">{{__('About Us')}}</a> </li>
							<li class="nav-item {{ Request::url()}}"><a href="{{url('/blog')}}" class="nav-link">{{__('Blog')}}</a> </li>
