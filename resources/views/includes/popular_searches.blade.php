			...
			<div class="tab-content" id="jobsby">				
                ...
                <div class="srchint">
                    <ul class="row catelist">
                        ...
                        <li class="col-md-3 col-sm-4 col-xs-6"><a href="{{route('job.list', ['functional_area_id[]'=>$functionalArea->functional_area_id])}}" title="{{$functionalArea->functional_area}}">{{$functionalArea->functional_area}} <span>({{$functional_area_id_num_jobs->num_jobs}})</span></a>
                        </li>
                ...
                <div class="srchint">
                    <ul class="row catelist">					
                        ...
                        ?> @if(null !== $industry)
                        <li class="col-md-3 col-sm-6 col-xs-6"><a href="{{route('job.list', ['industry_id[]'=>$industry->industry_id])}}" title="{{$industry->industry}}">{{$industry->industry}} <span>({{$num_jobs}})</span></a>
                        </li>
                        @endif @endforeach @endif
                    </ul>
                    <!--Categories end-->
