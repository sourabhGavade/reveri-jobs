<div class="col-lg-3">
    ...
    <ul class="usernavdash">
        <li class=""><a href="{{route('home')}}"><i class="fa fa-tachometer" aria-hidden="true"></i> {{__('Dashboard')}}</a>
        </li>
        ...
        <!--<li><a href="{{route('my.messages')}}"><i class="fa fa-envelope" aria-hidden="true"></i> {{__('My Messages')}}</a>
        </li>
