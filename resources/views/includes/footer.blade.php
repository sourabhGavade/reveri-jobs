            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    <?php 
                        ...
                        {
                    ?>
                    <li class="{{ Request::url() == route('cms', $footer_menu->page_slug) ? 'active' : '' }}"><a href="{{ route('cms', $footer_menu->page_slug) }}">{{ $cmsContent->seo_title ?? '-' }}</a></li>
                    <?php } ?>
                    @endforeach
                    <li><a href="{{ route('terms_conditions') }}">{{__('Terms & Conditions')}}</a></li>
                    <li><a href="{{ route('payment-policy') }}">{{__('Payment Policy')}}</a></li>
                    <li><a href="{{ route('recruiter-terms') }}">{{__('Recruiter Terms')}}</a></li>
...
<div class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <!--<div class="bttxt">{{__('Copyright')}} &copy; {{date('Y')}} {{ $siteSetting->site_name }}. {{__('All Rights Reserved')}}. {{__('Design by')}}: <a href="https://jellylogic.in" target="_blank">Jellylogic</a></div>-->
            </div>
            <div class="col-md-4">
