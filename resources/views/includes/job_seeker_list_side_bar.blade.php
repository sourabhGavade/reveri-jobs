<div class="col-md-3 col-sm-6"> 
    ...
    <div class="sidebar">
        ...
        <div class="widget">
            <h4 class="widget-title">{{__('By Job Position')}}</h4>
            <ul class="optionlist view_more_ul">
                ...
                @if(null !== $careerLevel)
                @php
                $checked = (in_array($careerLevel->career_level_id, Request::get('career_level_id',$detail->job_position??array())))? 'checked="checked"':'';
                @endphp
                <li>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                @if(isset($industry) && count($industry))
                @foreach($industry as $key=>$industry_id)
                @php
                $industry = App\Industry::where('industry','=',$industry_id)->lang()->active()->first();
                @endphp
                @if(null !== $industry)
                @php
                $checked = (in_array($industry->id, Request::get('industry_id',$detail->industry??array())))? 'checked="checked"':'';
                @endphp
                <li>
        ...
        <div class="widget">
            ...
            <ul class="optionlist view_more_ul">
                ...
                @foreach($functionalAreas as $key=>$functional_area_id)
                {{-- {{dd($functional_area_id)}} --}}
                @php
                $functionalArea = App\FunctionalArea::where('functional_area','=',$functional_area_id)->lang()->active()->first();
                @endphp
                @if(null !== $functionalArea)
                @php
                $checked = (in_array($functionalArea->functional_area_id, Request::get('functional_area_id',$detail->functional_area??array())))? 'checked="checked"':'';
                @endphp
                <li>
