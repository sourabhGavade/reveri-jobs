...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content" style="background-color:#eef1f5;"> 
        ...
        @if($Suggested_request->isNotEmpty())
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-share font-dark hide"></i> <span class="caption-subject font-dark bold uppercase">Recent Suggested candidates Request</span> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="slimScrol">
                            <ul class="feeds">
                                @foreach($Suggested_request as $SuggestedUser)
                                <li>
                                    <div class="col1">
                                        <div class="cont">
                                            <div class="cont-col1">
                                            ...
                                            <div class="cont-col2">
                                                <div class="desc"><a href="{{ route('edit.company', $SuggestedUser->id) }}"> {{ $SuggestedUser->name }} ({{ $SuggestedUser->email }}) </a>  - <i class="fa fa-home" aria-hidden="true"></i> {{ $SuggestedUser->getLocation()}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
