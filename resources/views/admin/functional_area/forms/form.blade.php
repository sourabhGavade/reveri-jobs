...
<div class="form-body">
    ...
    <!-- @if(isset($packages))
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'Packages') !!}">
        {!! Form::label('lang', 'Packages', ['class' => 'bold']) !!}                    
        {!! Form::select('package_id', ['' => 'Select packages']+$packages,$packages, array('class'=>'form-control', 'id'=>'package_id', 'onchange'=>'setpackages(this.value)')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'Packages') !!}                                       
    </div>
    @endif -->
