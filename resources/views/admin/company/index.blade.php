                                ...
                                <table class="table table-striped table-bordered table-hover"  id="companyDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><select name="is_approved" id="is_approved" class="form-control">
...
<script>
    ...
    function makeApproved(id) {
        $.post("{{ route('make.approved.company') }}", {id: id, _method: 'PUT', _token: '{{ csrf_token() }}'})
                .done(function (response) {
                    if (response == 'ok')
                    {
                        var table = $('#companyDatatableAjax').DataTable();
    ...
    function makeNotApproved(id) {
        $.post("{{ route('make.not.approved.company') }}", {id: id, _method: 'PUT', _token: '{{ csrf_token() }}'})
                .done(function (response) {
                    if (response == 'ok')
                    {
                        var table = $('#companyDatatableAjax').DataTable();
