...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_title') !!}"> {!! Form::label('seo_title', 'SEO Title', ['class' => 'bold']) !!}
        {!! Form::text('seo_title', null, array('class'=>'form-control', 'id'=>'seo_title', 'placeholder'=>'SEO Title')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_title') !!} </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_description') !!}"> {!! Form::label('seo_description', 'SEO Description', ['class' => 'bold']) !!}
        {!! Form::text('seo_description', null, array('class'=>'form-control', 'id'=>'seo_description', 'placeholder'=>'SEO Description')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_description') !!} </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_tags') !!}"> {!! Form::label('seo_tags', 'SEO Tags', ['class' => 'bold']) !!}
        {!! Form::text('seo_tags', null, array('class'=>'form-control', 'id'=>'seo_tags', 'placeholder'=>'SEO Tags')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_tags') !!} </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_approved') !!}">
        {!! Form::label('is_approved', 'Is Featured?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
            $is_approved_1 = '';
            $is_approved_2 = 'checked="checked"';
            if (old('is_approved', ((isset($company)) ? $company->is_approved : 0)) == 1) {
                $is_approved_1 = 'checked="checked"';
                $is_approved_2 = '';
            }
            ?>
            <label class="radio-inline">
                <input id="approved" name="is_approved" type="radio" value="1" {{$is_approved_1}}>
                Approved </label>
            <label class="radio-inline">
                <input id="not_approved" name="is_approved" type="radio" value="0" {{$is_approved_2}}>
                Not Approved </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'is_approved') !!} 
    </div>
