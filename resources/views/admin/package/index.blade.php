                                ...
                                <table class="table table-striped table-bordered table-hover"  id="packageDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td><input type="text" class="form-control" name="package_num_listings" id="package_num_listings" autocomplete="off" placeholder="package job post"></td>
                                            <td><input type="text" class="form-control" name="num_data_access" id="num_data_access" autocomplete="off" placeholder="package view CV's"></td>
...
<script>
    $(function () {
        var oTable = $('#packageDatatableAjax').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.num_data_access = $('#num_data_access').val();
                ...
                {data: 'num_data_access', name: 'num_data_access'},
        ...
        $('#num_data_access').on('keyup', function (e) {
            oTable.draw();
            e.preventDefault();
        });
