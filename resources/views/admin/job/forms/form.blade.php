...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div">
        {!! Form::label('career_level_id', 'Job Position', ['class' => 'bold']) !!}                    
        {!! Form::select('career_level_id', ['' => 'Select Job Position']+$careerLevels, null, array('class'=>'form-control', 'id'=>'career_level_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
     ...
     <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_title') !!}">
        {!! Form::label('seo_title', 'Job SEO Title', ['class' => 'bold']) !!}
        {!! Form::text('seo_title', null, array('class'=>'form-control', 'id'=>'seo_title', 'placeholder'=>'Job SEO Title')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_title') !!}
    </div>
     <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_description') !!}">
        {!! Form::label('seo_description', 'Job SEO Description', ['class' => 'bold']) !!}
        {!! Form::text('seo_description', null, array('class'=>'form-control', 'id'=>'seo_description', 'placeholder'=>'Job SEO Description')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_description') !!}
    </div>
     <div class="form-group {!! APFrmErrHelp::hasError($errors, 'seo_tags') !!}">
        {!! Form::label('seo_tags', 'Job SEO Tags', ['class' => 'bold']) !!}
        {!! Form::text('seo_tags', null, array('class'=>'form-control', 'id'=>'seo_tags', 'placeholder'=>'Job SEO Tags')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'seo_tags') !!}
    </div>
