    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Job Postion</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Manage Job Position <small>Job Position</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Job Position</span> </div>
                        <div class="actions"> <a href="{{ route('create.career.level') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add New Job Position</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="careerLevelDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="career_level" id="career_level" autocomplete="off" placeholder="Job Position"></td>                      
...
<script>
    ...
    function deleteCareerLevel(id, is_default) {
        ...
        if (is_default == 1) {
            msg = 'Are you sure? You are going to delete default Job Position, all other non default Job Position will be deleted too!';
        }
        if (confirm(msg)) {
