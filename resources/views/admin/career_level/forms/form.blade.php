...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'career_level') !!}"> {!! Form::label('career_level', 'Job Position', ['class' => 'bold']) !!}                    
        {!! Form::text('career_level', null, array('class'=>'form-control', 'id'=>'career_level', 'placeholder'=>'Job Position', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div"> {!! Form::label('career_level_id', 'Default Job Position', ['class' => 'bold']) !!}                    
        {!! Form::select('career_level_id', ['' => 'Select Default Job Position']+$careerLevels, null, array('id'=>'career_level_id', 'class'=>'form-control')) !!}
