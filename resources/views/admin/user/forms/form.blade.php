...
<div class="form-body">    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'password') !!}">
        {!! Form::label('password_confirmation', 'Confirmation Password', ['class' => 'bold']) !!}                    
        {!! Form::password('password_confirmation', array('class'=>'form-control', 'id'=>'password_confirmation', 'placeholder'=>'Confirmation Password')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'industry') !!}">
        ...
        {!! Form::select('industry[]', [''=>'Select Industry']+$industries, null, array('class'=>'form-control', 'id'=>'industry')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'functional_area') !!}">
        ...
        {!! Form::select('functional_area[]', [''=>'Select Functional Area']+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area')) !!}
