...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $Suggested_company = Suggested_request::pluck('company_id');
        $Suggested_request = Company::orderBy('id', 'DESC')->whereIn('id',$Suggested_company->toArray())->take(25)->get();
        ...
        return view('admin.home')
                        ...
                        ->with('Suggested_request', $Suggested_request)
