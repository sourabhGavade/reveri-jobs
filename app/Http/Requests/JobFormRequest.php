    ...
    public function messages()
    {
        return [
            ...
            'is_featured.required' => 'Is this Job featured?',
             'seo_title.max' => __('SEO title should not be more than 70 characters'),
            'seo_description.max' => __('SEO description should not be more than 160 characters'),
            'seo_tags.max' => __('SEO tags should not be more than 150 characters'),
        ];
    }
